...
Adversarial_agent.load_checkpoint("Adv_agent_model/Adv_model.tar")

# Ego_agent
Ego_agent = SAC(env.observation_space_size_of_ego, env.action_space_of_ego, args)
Ego_agent.load_checkpoint("ego_agent_model/ego_agent.tar")

#Tesnorboard
writer = SummaryWriter('/home/smartcps/Desktop/Airsim_model_files/Scenario_2_runs/{}_SAC_{}_{}_{}'.format(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S"), args.env_name,
                                                             args.policy, "autotune" if args.automatic_entropy_tuning else ""))
model_path = '/home/smartcps/Desktop/Airsim_model_files/Scenario_2_models/{}_SAC_{}_{}_{}/'.format(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S"), args.env_name,
                                                             args.policy, "autotune" if args.automatic_entropy_tuning else "")
# Memory
