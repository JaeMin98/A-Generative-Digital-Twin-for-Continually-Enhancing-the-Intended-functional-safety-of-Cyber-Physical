...
# EMA를 계산하는 함수
def calculate_ema(data, alpha=0.03):
    ema = [data[0]]
...
plot_data(data[:250], "Success_rate (%)", "(b) The success rate of the adversarial agent during training (lr=0.001)", "양수Reward_successrate.png")
