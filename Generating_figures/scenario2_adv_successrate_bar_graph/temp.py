...
def plot_data(data, ylabel, title, figname):
    ...
    plt.xticks(np.arange(0, len(data), 300), fontsize=15)
...
plot_data(data[:1588], "Success_rate (%)", "(c) The success rate of the adversarial agent during training", "figure14_success_rate.png")
